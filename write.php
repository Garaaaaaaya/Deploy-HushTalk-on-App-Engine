...
<body style="background-color:#DFEEF4" ;>
  ...
  <form action="writeproses.php" method="POST" enctype="multipart/form-data">
    <div class="container-md" style="max-width: 600px; padding-top: 110px; background-color: #92ABB7; padding-bottom: 20px;">
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            <label for="to" style="color: #053144;">Kepada</label>
            <input type="text" name="receiver" class="form-control" id="receiver" placeholder="Email tujuan">
          </div>
          <div class="form-group">
